...
This tutorial is based on the [Software Carpentry Unix Shell](http://swcarpentry.github.io/shell-novice/))  lesson. We will refer to it for background information. As you become familiar with the Unix Shell, it will be worth reviewing some of the more advanced topics in the SWC lesson [Shell Extras](http://swcarpentry.github.io/shell-extras/). 
